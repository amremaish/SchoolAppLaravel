...
<a href= "/" class = "fa fa-home fa-5x" style= "margin-right: 5%; cursor: pointer;">
...
<div id="frame">
    ...
    <br>
		<div id="contacts">
			<ul>
      @for ($x = 0 ; $x < count($data["chat_users"])  ; $x++) 
          <li class="contact" onclick='openChat("{{Session::get("cur_user")["email"]}}" , "{{$data["chat_users"][$x]["email"]}}" , "{{$data["chat_users"][$x]["imagePath"]}}"  , "{{$data["chat_users"][$x]["username"]}}"  , "{{Session::get("cur_user")["username"]}}") '  >
            <div class="wrap">
              <img  style = "width:45px ; height:45px;margin-top:6px"src={{$data["chat_users"][$x]["imagePath"]}} alt="" />
              <div class="meta">
                <p class="name">{{$data["chat_users"][$x]["username"]}}</p>
                <p style = "margin-top:4px ;">{{$data["chat_users"][$x]["userType"]}}</p>
              </div>
            </div>
          </li>
      @endfor
	...
	<div class="content">
		<div class="contact-profile">
			<img id = "opend_img" style = "width:40px ; height:40px;"/>
			<p id = "opend_name"></p>
		</div>
		<div class="messages">
			<ul id ="msg_list">
		...
		<div class="message-input">
			<div class="wrap">
			<input style= "width:92.4%"type="text" placeholder="Write your message..." />
